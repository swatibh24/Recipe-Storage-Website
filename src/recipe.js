...
const homeDom = document.querySelector('#homePage');
const loginDom = document.querySelector('#loginPage');
const newRecipeDom = document.querySelector('#newRecipe');
const recipeDescriptionDom = document.querySelector('#descriptionPage');
...
userCreate.addEventListener('click', (e) => {
    if (!e.target.classList.contains('login-user')) {
        return;
    }
