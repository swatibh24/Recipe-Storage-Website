...
var homeDom = document.querySelector('#homePage');
var loginDom = document.querySelector('#loginPage');
var newRecipeDom = document.querySelector('#newRecipe');
var recipeDescriptionDom = document.querySelector('#descriptionPage');
